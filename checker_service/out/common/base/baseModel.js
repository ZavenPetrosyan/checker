...
class BaseModel {
    ...
    static async update(data, byFields = { id: data.id }, conflictRule, model) {
        const clone = lodash_1.cloneDeep(data);
        ...
        query += " returning *;";
        const result = await BaseModel.oneRaw(query);
        return result ? new (model || this)(result) : undefined;
    }
    async update(data = this, byFields, conflictRule) {
        Object.assign(this, data);
        return (await BaseModel.update(data, byFields, conflictRule, this.constructor)) || this;
    }
}
